...
<div class="wrap ays_results_table">
    ...
    <div class="question-action-butons">
        <a href="https://ays-pro.com/wordpress/survey-maker" class="button button-primary" style="float: right;opacity: 0.5;" target="_blank"><?php echo __('Export', "survey-maker"); ?></a>
    </div>
