                ...
                <div class="ays-survey-themes-main-div ays-survey-themes-main-div-only-pro">
                    <div class="form-group row" style="margin:0px;">
                        <div class="col-sm-12 ays-pro-features-v2-main-box ays-pro-features-v2-main-box-themes ays-pro-features-v2-main-box-small">
                            <div class="ays-pro-features-v2-small-buttons-box">
                                <div>
                                    <a href="https://ays-demo.com/contact-form/" target="_blank" class="ays-pro-features-v2-view-demo-button">
                                        <div class="ays-pro-features-v2-view-demo-icon" style="background-image: url('<?php echo esc_attr(SURVEY_MAKER_ADMIN_URL); ?>/images/icons/pro-features-icons/view-demo.svg');"></div>
                                        <div class="ays-pro-features-v2-view-demo-text">
                                            <?php echo __("View demo" , "survey-maker"); ?>
                                        </div>
    ...
    <div class="row">
        <div class="col-lg-7 col-sm-12">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7 ays_divider_left ays_survey_display_flex_width">
                    <div>
                        <input type="number" class="ays-text-input ays-text-input-short" id='ays_survey_title_letter_spacing'name='ays_survey_title_letter_spacing' value="<?php echo esc_attr($survey_title_letter_spacing); ?>"/>
                    </div>
                    <div class="ays_dropdown_max_width">
                        <input type="text" value="px" class='ays-form-hint-for-size' disabled>
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7 ays_divider_left ays_survey_display_flex_width">
                    <div>
                        <input type="number" class="ays-text-input ays-text-input-short" id='ays_survey_section_title_letter_spacing'name='ays_survey_section_title_letter_spacing' value="<?php echo esc_attr($survey_section_title_letter_spacing); ?>"/>
                    </div>
                    <div class="ays_dropdown_max_width">
                        <input type="text" value="px" class='ays-form-hint-for-size' disabled>
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7 ays_divider_left ays_survey_display_flex_width">
                    <div>
                        <input type="number" class="ays-text-input ays-text-input-short" id='ays_survey_section_description_letter_spacing'name='ays_survey_section_description_letter_spacing' value="<?php echo esc_attr($survey_section_description_letter_spacing); ?>"/>
                    </div>
                    <div class="ays_dropdown_max_width">
                        <input type="text" value="px" class='ays-form-hint-for-size' disabled>
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7 ays_divider_left ays_survey_display_flex_width">
                    <div>
                        <input type="number" class="ays-text-input ays-text-input-short" id='ays_survey_question_caption_letter_spacing'name='ays_survey_question_caption_letter_spacing' value="<?php echo esc_attr($survey_question_caption_letter_spacing); ?>"/>
                    </div>
                    <div class="ays_dropdown_max_width">
                        <input type="text" value="px" class='ays-form-hint-for-size' disabled>
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7 ays_divider_left ays_survey_display_flex_width">
                    <div>
                        <input type="number" class="ays-text-input ays-text-input-short" id='ays_survey_answer_letter_spacing'name='ays_survey_answer_letter_spacing' value="<?php echo esc_attr($survey_answer_letter_spacing); ?>"/>
                    </div>
                    <div class="ays_dropdown_max_width">
                        <input type="text" value="px" class='ays-form-hint-for-size' disabled>
                    </div>
    ...
    <div class="form-group row"> <!-- Buttons Styles -->
        <div class="col-lg-7 col-sm-12">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7 ays_divider_left ays_survey_display_flex_width">
                    <div>
                        <input type="number" class="ays-text-input ays-text-input-short" id='ays_survey_buttons_font_size' name='ays_survey_buttons_font_size' value="<?php echo esc_attr($survey_buttons_font_size); ?>"/>
                    </div>
                    <div class="ays_dropdown_max_width">
                        <input type="text" value="px" class='ays-form-hint-for-size' disabled>
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7 ays_divider_left ays_survey_display_flex_width">
                    <div>
                        <input type="number" class="ays-text-input ays-text-input-short" id='ays_survey_buttons_text_letter_spacing'name='ays_survey_buttons_text_letter_spacing' value="<?php echo esc_attr($survey_buttons_text_letter_spacing); ?>"/>
                    </div>
                    <div class="ays_dropdown_max_width">
                        <input type="text" value="px" class='ays-form-hint-for-size' disabled>
                    </div>
