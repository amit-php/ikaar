    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <select id="ays-status" name="<?php echo esc_attr($html_name_prefix); ?>status">
                <option></option>
                <option <?php selected( esc_attr($status), 'published' ); ?> value="published"><?php echo __( "Published", "survey-maker" ); ?></option>
                <option <?php selected( esc_attr($status), 'draft' ); ?> value="draft"><?php echo __( "Draft", "survey-maker" ); ?></option>
            </select>
        </div>
    </div> <!-- Status -->
</div>
