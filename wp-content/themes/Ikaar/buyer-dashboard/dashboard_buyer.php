...
if (isset($_POST['cpisub'])) {
   ...
   if ($image) {
      ...
      //  $fileExtension = pathinfo("image.png", PATHINFO_EXTENSION);
      //  echo $fileExtension; 
               ...
               <div class="my-account-section">
                  ...
                  <div class="account-details-box">
                     <div class="account-details-inner-row d-flex justify-content-between align-items-center">
                        ...
                        <?php $edit_btn_title = get_theme_value('edit_btn_buyer');
                        $edit_btn_link = get_theme_value('edit_url_buyer');
                        if (!empty($edit_btn_title)) { ?>
                           <div class="button-row">
                              <a href="<?php echo $edit_btn_link; ?>" class="btn">
                                 <?php echo $edit_btn_title; ?>
                              </a>
                           </div>
                        <?php } ?>
                     </div>
      ...
      <div class="modal-content">
         <div class="modal-header">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
               <input type="file" name="cpiimage">
               <input type="submit" name="cpisub" lable="upload">
            </form>
